    ...
    init {
        ...
        describe("maxSize") {
            ...
            it("maxSize should reject a bigger list") {
                val result = validator.validate(of(1, 2, 3, 4, 5))
        ...
        describe("allValid") {
            ...
            it("allValid should accept a list with all element valid") {
                val result = validator.validate(of(10, 11, 12))
                result should beValid()
            }

            it("allValid should reject a list with at least an element invalid") {
                val result = validator.validate(of(10, 4, 12))
